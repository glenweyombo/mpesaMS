...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.wefi.payment.mpesa.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.wefi.payment.mpesa.security.DomainUserDetailsService", "createSpringSecurityUser");
